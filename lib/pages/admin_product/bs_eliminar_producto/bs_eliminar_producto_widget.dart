...
class BsEliminarProductoWidget extends StatefulWidget {
  /// En este apartado, se debe de ingresar la palabra "eliminar" y seleccionar
  /// el botón, para que los productos se eliminen.
...
class _BsEliminarProductoWidgetState extends State<BsEliminarProductoWidget> {
  ...
  void initState() {
    ...
    _model.txtEliminarTextController ??= TextEditingController();
    _model.txtEliminarFocusNode ??= FocusNode();
  }
                ...
                children: [
                  Expanded(
                    child: Padding(
                      ...
                      child: TextFormField(
                        controller: _model.txtEliminarTextController,
                        focusNode: _model.txtEliminarFocusNode,
                        autofocus: true,
                        obscureText: false,
                        ...
                        validator: _model.txtEliminarTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ),
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        if (_model.txtEliminarTextController.text ==
                            'Eliminar') {
