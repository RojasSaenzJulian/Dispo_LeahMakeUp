...
class ProductosWidget extends StatefulWidget {
  /// En este apartado los ususarios pueden ver los productos con su respectivo
  /// precio, y en su categoría adecuada, además se puede agregar a carrito.
                        ...
                        children: [
                          Align(
                            ...
                            child: FlutterFlowButtonTabBar(
                              ...
                              labelColor: const Color(0xD2A63463),
                              unselectedLabelColor: const Color(0xB7252D32),
                              backgroundColor: const Color(0xFFF7C2C1),
                              borderColor: const Color(0x4CD045AB),
                              borderWidth: 2.0,
                              borderRadius: 12.0,
                              elevation: 0.0,
                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                              () async {
                                                                            await SubproductosRecord.collection.doc().set(createSubproductosRecordData(
                                                                                  producto: listViewProductosRecord.reference,
                                                                                  cantidad: 1,
                                                                                  subtotal: 0.0,
                                                                                ));
