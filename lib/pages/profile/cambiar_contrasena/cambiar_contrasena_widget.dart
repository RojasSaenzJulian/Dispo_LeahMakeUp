...
class _CambiarContrasenaWidgetState extends State<CambiarContrasenaWidget> {
  ...
  void initState() {
    ...
    _model.txtContrasenaActualTextController ??= TextEditingController();
    _model.txtContrasenaActualFocusNode ??= FocusNode();

    _model.txtContrasenaNuevaTextController ??= TextEditingController();
    _model.txtContrasenaNuevaFocusNode ??= FocusNode();
  }
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                1.0, 0.0, 0.0, 0.0),
                            child: Text(
                              'Ingrese su contraseña actual y enseguida \nsu contraseña nueva',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtContrasenaActualFocusNode,
                                autofocus: true,
                                obscureText:
                                    !_model.txtContrasenaActualVisibility,
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.txtContrasenaNuevaFocusNode,
                                autofocus: true,
                                obscureText:
                                    !_model.txtContrasenaNuevaVisibility,
                                decoration: InputDecoration(
                                  labelStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
