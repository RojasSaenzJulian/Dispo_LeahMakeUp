...
class CambiarCorreoWidget extends StatefulWidget {
  ...
  @override
  State<CambiarCorreoWidget> createState() => _CambiarCorreoWidgetState();
}
...
class _CambiarCorreoWidgetState extends State<CambiarCorreoWidget> {
  ...
  void initState() {
    ...
    _model.txtCorreoNuevoTextController ??= TextEditingController();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          'Ingrese su correo nuevo y enseguida \nsu contraseña actual',
                          style:
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(15.0, 10.0, 5.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: TextFormField(
                            controller: _model.txtCorreoNuevoTextController,
