...
import 'cambiar_numero_model.dart';
...
class CambiarNumeroWidget extends StatefulWidget {
  ...
  @override
  State<CambiarNumeroWidget> createState() => _CambiarNumeroWidgetState();
}

class _CambiarNumeroWidgetState extends State<CambiarNumeroWidget> {
  late CambiarNumeroModel _model;
