...
class _BsEditarCategoriaWidgetState extends State<BsEditarCategoriaWidget> {
  ...
  void initState() {
    ...
    _model.txtEditNombreTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.categoriaEditar?.nombreCategoria,
      'sin nombre',
    ));
    _model.txtEditNombreFocusNode ??= FocusNode();
  }
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: TextFormField(
                      controller: _model.txtEditNombreTextController,
                      focusNode: _model.txtEditNombreFocusNode,
                      autofocus: true,
                      obscureText: false,
                      ...
                      validator: _model.txtEditNombreTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                ...
                FFButtonWidget(
                  onPressed: () async {
                    await widget.categoriaEditar!.reference
                      ...
                      nombreCategoria: _model.txtEditNombreTextController.text,
                    ));
